(function() {
  ...
  angular
    ...
    .factory('PDFDownload', PDFDownload);

  PDFDownload.$inject = ['$resource','$locale','localeMapper', 'ENVIRONMENT'];
  /**
   * VENKAD09
   * @ngdoc method
   * @name Template
   ...
   * 
   */
  function PDFDownload($resource,$locale,localeMapper, ENVIRONMENT) {

	return $resource(
      ENVIRONMENT.SERVICE_URI + ':locale/pdf-download/:id' + ENVIRONMENT.SERVICE_EXT,
      {
      	  id: '@id',
