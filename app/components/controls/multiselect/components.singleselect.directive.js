...
(function () {
  ...
  angular
    ...
    .directive('gcmsSingleselect', Singleselect);

  Singleselect.$inject = ['state'];
    ...
    function Singleselect(state) {
      return {
        ...
        templateUrl: 'app/components/controls/multiselect/components.singleselect.html',
        controller: function($scope, $rootScope, $log, $filter) {
          ...
          $scope.$watch('model.value', function() {
        	  if(typeof $scope.model.value === 'object'){
        		  $scope.value = $scope.model.value.id;
        	  } else {
