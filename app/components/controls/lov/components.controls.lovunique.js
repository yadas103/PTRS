...
(function () {
  ...
  angular
    ...
    .directive('gcmsLovunique', gcmsLovunique);

    gcmsLovunique.$inject = [];
    ...
    function gcmsLovunique() {
      return {
        ...
        templateUrl: 'app/components/controls/lov/components.controls.lovunique.html',
